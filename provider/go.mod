module github.com/kitzin/pulumi-vcd/provider
...
require (
	...
	github.com/vmware/terraform-provider-vcd/v3 v3.8.2
)
...
require (
	...
	github.com/vmware/go-vcloud-director/v2 v2.19.0 // indirect
