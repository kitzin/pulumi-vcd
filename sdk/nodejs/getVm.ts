...
export function getVm(args: GetVmArgs, opts?: pulumi.InvokeOptions): Promise<GetVmResult> {
    ...
    return pulumi.runtime.invoke("vcd:index/getVm:getVm", {
        "name": args.name,
...
export interface GetVmResult {
    ...
    readonly customizations: outputs.GetVmCustomization[];
    readonly description: string;
    readonly disks: outputs.GetVmDisk[];
     ...
     */
    readonly id: string;
    readonly internalDisks: outputs.GetVmInternalDisk[];
    ...
    readonly metadataEntries: outputs.GetVmMetadataEntry[];
    readonly name: string;
    readonly networkDhcpWaitSeconds?: number;
    readonly networks: outputs.GetVmNetwork[];
    readonly org?: string;
...
export function getVmOutput(args: GetVmOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVmResult> {
    return pulumi.output(args).apply(a => getVm(a, opts))
}
