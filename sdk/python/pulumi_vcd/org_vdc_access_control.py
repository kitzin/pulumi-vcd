...
class OrgVdcAccessControlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] everyone_access_level: Access level when the VDC is shared with everyone (only ReadOnly is available). Required when shared_with_everyone is
               set
...
class OrgVdcAccessControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 org: Optional[pulumi.Input[str]] = None,
                 shared_with_everyone: Optional[pulumi.Input[bool]] = None,
                 shared_withs: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OrgVdcAccessControlSharedWithArgs']]]]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a OrgVdcAccessControl resource with the given unique name, props, and options.
