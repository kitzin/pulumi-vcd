...
class VmAffinityRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] polarity: One of 'Affinity', 'Anti-Affinity'
        :param pulumi.Input[Sequence[pulumi.Input[str]]] vm_ids: Set of VM IDs assigned to this rule
        :param pulumi.Input[bool] enabled: True if this affinity rule is enabled
        :param pulumi.Input[str] name: VM affinity rule name
        ...
        :param pulumi.Input[bool] required: True if this affinity rule is required. When a rule is mandatory, a host failover will not power on the VM if doing so
