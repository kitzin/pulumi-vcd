...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] auth_type: 'integrated', 'saml_adfs', 'token', and 'api_token' are the only ones supported now. 'integrated' is default.
        :param pulumi.Input[str] import_separator: Defines the import separation string to be used with 'terraform import'
