...
def get_nsxt_edgegateway_bgp_neighbor(edge_gateway_id: Optional[str] = None,
    ...
    return AwaitableGetNsxtEdgegatewayBgpNeighborResult(
        allow_as_in=__ret__.allow_as_in,
        bfd_dead_multiple=__ret__.bfd_dead_multiple,
        bfd_enabled=__ret__.bfd_enabled,
        bfd_interval=__ret__.bfd_interval,
        edge_gateway_id=__ret__.edge_gateway_id,
        graceful_restart_mode=__ret__.graceful_restart_mode,
        hold_down_timer=__ret__.hold_down_timer,
        id=__ret__.id,
        in_filter_ip_prefix_list_id=__ret__.in_filter_ip_prefix_list_id,
        ip_address=__ret__.ip_address,
        keep_alive_timer=__ret__.keep_alive_timer,
        org=__ret__.org,
        out_filter_ip_prefix_list_id=__ret__.out_filter_ip_prefix_list_id,
        password=__ret__.password,
        remote_as_number=__ret__.remote_as_number,
        route_filtering=__ret__.route_filtering)


@_utilities.lift_output_func(get_nsxt_edgegateway_bgp_neighbor)
def get_nsxt_edgegateway_bgp_neighbor_output(edge_gateway_id: Optional[pulumi.Input[str]] = None,
                                             ip_address: Optional[pulumi.Input[str]] = None,
                                             org: Optional[pulumi.Input[Optional[str]]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNsxtEdgegatewayBgpNeighborResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
