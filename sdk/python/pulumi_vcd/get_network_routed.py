...
def get_network_routed(filter: Optional[pulumi.InputType['GetNetworkRoutedFilterArgs']] = None,
...
@_utilities.lift_output_func(get_network_routed)
def get_network_routed_output(filter: Optional[pulumi.Input[Optional[pulumi.InputType['GetNetworkRoutedFilterArgs']]]] = None,
                              name: Optional[pulumi.Input[Optional[str]]] = None,
                              org: Optional[pulumi.Input[Optional[str]]] = None,
                              vdc: Optional[pulumi.Input[Optional[str]]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNetworkRoutedResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
