...
class LbAppProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] edge_gateway: Edge gateway name in which the LB Application Profile is located
        :param pulumi.Input[str] type: Protocol type used to send requests to the server. One of 'tcp', 'udp', 'http' org 'https'
        :param pulumi.Input[str] cookie_mode: The mode by which the cookie should be inserted. One of 'insert', 'prefix', or 'appsession'
        :param pulumi.Input[str] cookie_name: Used to uniquely identify the session the first time a client accesses the site. The load balancer refers to this cookie
        ...
        :param pulumi.Input[bool] enable_pool_side_ssl: Enable to define the certificate, CAs, or CRLs used to authenticate the load balancer from the server side
        :param pulumi.Input[bool] enable_ssl_passthrough: Enable SSL authentication to be passed through to the virtual server. Otherwise SSL authentication takes place at the
               destination address.
        :param pulumi.Input[int] expiration: Length of time in seconds that persistence stays in effect
        :param pulumi.Input[str] http_redirect_url: The URL to which traffic that arrives at the destination address should be redirected. Only applies for types 'http' and
               'https'
        :param pulumi.Input[bool] insert_x_forwarded_http_header: Enables 'X-Forwarded-For' header for identifying the originating IP address of a client connecting to a Web server
               through the load balancer. Only applies for types HTTP and HTTPS
        :param pulumi.Input[str] name: Unique LB Application Profile name
        ...
        :param pulumi.Input[str] persistence_mechanism: Persistence mechanism for the profile. One of 'cookie', 'ssl-sessionid', 'sourceip'
