...
class LbServiceMonitorArgs:
    def __init__(__self__, *,
                 ...
                 extension: Optional[pulumi.Input[Mapping[str, Any]]] = None,
        ...
        :param pulumi.Input[str] edge_gateway: Edge gateway name in which the LB Service Monitor is located
        :param pulumi.Input[str] type: Way in which you want to send the health check request to the server. One of http, https, tcp, icmp, or udp
        :param pulumi.Input[str] expected: String that the monitor expects to match in the status line of the http or https response (for example, HTTP/1.1)
        :param pulumi.Input[Mapping[str, Any]] extension: Advanced monitor parameters as key=value pairs
        :param pulumi.Input[int] interval: Interval in seconds at which a server is to be monitored (defaults to 10)
        :param pulumi.Input[int] max_retries: Number of times the specified monitoring Method must fail sequentially before the server is declared down (defaults to
               3)
        :param pulumi.Input[str] method: Method to be used to detect server status. One of OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, or CONNECT
        :param pulumi.Input[str] name: Unique LB Service Monitor name
        ...
        :param pulumi.Input[str] receive: String to be matched in the response content
        :param pulumi.Input[str] send: Data to be sent
        ...
        :param pulumi.Input[str] url: URL to be used in the server status request
    ...
    @property
    @pulumi.getter
    def extension(self) -> Optional[pulumi.Input[Mapping[str, Any]]]:
        """
    ...
    @extension.setter
    def extension(self, value: Optional[pulumi.Input[Mapping[str, Any]]]):
...
class LbServiceMonitor(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def extension(self) -> pulumi.Output[Optional[Mapping[str, Any]]]:
        """
        Advanced monitor parameters as key=value pairs
        """
        return pulumi.get(self, "extension")
