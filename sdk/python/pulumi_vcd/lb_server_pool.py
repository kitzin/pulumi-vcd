...
class LbServerPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] algorithm: Balancing method for the service. One of 'ip-hash', 'round-robin', 'uri', 'leastconn', 'url', or 'httpheader'
        :param pulumi.Input[str] edge_gateway: Edge gateway name in which the LB Server Pool is located
        :param pulumi.Input[str] algorithm_parameters: Additional options for load balancing algorithm for httpheader or url algorithms
        :param pulumi.Input[str] description: Server pool description
        :param pulumi.Input[bool] enable_transparency: Makes client IP addresses visible to the backend servers
        :param pulumi.Input[str] monitor_id: Load Balancer Service Monitor ID
        :param pulumi.Input[str] name: Unique LB Server Pool name
...
class LbServerPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 edge_gateway: Optional[pulumi.Input[str]] = None,
                 enable_transparency: Optional[pulumi.Input[bool]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LbServerPoolMemberArgs']]]]] = None,
                 monitor_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 org: Optional[pulumi.Input[str]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
