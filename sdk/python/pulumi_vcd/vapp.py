...
class VappArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: Optional description of the vApp
        :param pulumi.Input[Mapping[str, Any]] guest_properties: Key/value settings for guest properties. Will be picked up by new VMs when created.
        :param pulumi.Input['VappLeaseArgs'] lease: Defines lease parameters for this vApp
        :param pulumi.Input[Mapping[str, Any]] metadata: Key value map of metadata to assign to this vApp. Key and value can be any string.
        :param pulumi.Input[Sequence[pulumi.Input['VappMetadataEntryArgs']]] metadata_entries: Metadata entries for the given vApp
        :param pulumi.Input[str] name: A name for the vApp, unique withing the VDC
        ...
        :param pulumi.Input[bool] power_on: A boolean value stating if this vApp should be powered on
...
class _VappState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: Optional description of the vApp
        :param pulumi.Input[Mapping[str, Any]] guest_properties: Key/value settings for guest properties. Will be picked up by new VMs when created.
        :param pulumi.Input[str] href: vApp Hyper Reference
        :param pulumi.Input['VappLeaseArgs'] lease: Defines lease parameters for this vApp
        :param pulumi.Input[Mapping[str, Any]] metadata: Key value map of metadata to assign to this vApp. Key and value can be any string.
        :param pulumi.Input[Sequence[pulumi.Input['VappMetadataEntryArgs']]] metadata_entries: Metadata entries for the given vApp
        :param pulumi.Input[str] name: A name for the vApp, unique withing the VDC
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[bool] power_on: A boolean value stating if this vApp should be powered on
        :param pulumi.Input[int] status: Shows the status code of the vApp
        :param pulumi.Input[str] status_text: Shows the status of the vApp
        :param pulumi.Input[str] vdc: The name of VDC to use, optional if defined at provider level
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class Vapp(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 guest_properties: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 lease: Optional[pulumi.Input[pulumi.InputType['VappLeaseArgs']]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 metadata_entries: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VappMetadataEntryArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 org: Optional[pulumi.Input[str]] = None,
                 power_on: Optional[pulumi.Input[bool]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] description: Optional description of the vApp
        :param pulumi.Input[Mapping[str, Any]] guest_properties: Key/value settings for guest properties. Will be picked up by new VMs when created.
        :param pulumi.Input[pulumi.InputType['VappLeaseArgs']] lease: Defines lease parameters for this vApp
        :param pulumi.Input[Mapping[str, Any]] metadata: Key value map of metadata to assign to this vApp. Key and value can be any string.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VappMetadataEntryArgs']]]] metadata_entries: Metadata entries for the given vApp
        :param pulumi.Input[str] name: A name for the vApp, unique withing the VDC
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[bool] power_on: A boolean value stating if this vApp should be powered on
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[int]] = None,
            status_text: Optional[pulumi.Input[str]] = None,
            vdc: Optional[pulumi.Input[str]] = None) -> 'Vapp':
        """
