...
class NetworkDirectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NetworkDirectMetadataEntryArgs']]] metadata_entries: Metadata entries for the given Network
...
class _NetworkDirectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: Optional description for the network
        :param pulumi.Input[str] external_network: The name of the external network
        :param pulumi.Input[str] external_network_dns1: Main DNS of the external network
        :param pulumi.Input[str] external_network_dns2: Secondary DNS of the external network
        :param pulumi.Input[str] external_network_dns_suffix: DNS suffix of the external network
        :param pulumi.Input[str] external_network_gateway: Gateway of the external network
        :param pulumi.Input[str] external_network_netmask: Net mask of the external network
...
class NetworkDirect(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 external_network: Optional[pulumi.Input[str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 metadata_entries: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkDirectMetadataEntryArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 org: Optional[pulumi.Input[str]] = None,
                 shared: Optional[pulumi.Input[bool]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] external_network: The name of the external network
        :param pulumi.Input[Mapping[str, Any]] metadata: Key value map of metadata to assign to this network. Key and value can be any string
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkDirectMetadataEntryArgs']]]] metadata_entries: Metadata entries for the given Network
        :param pulumi.Input[str] name: A unique name for this network
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[bool] shared: Defines if this network is shared between multiple VDCs in the Org
