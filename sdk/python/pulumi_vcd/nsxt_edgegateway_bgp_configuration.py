...
class NsxtEdgegatewayBgpConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] edge_gateway_id: Edge gateway ID for BGP Configuration
        :param pulumi.Input[bool] enabled: Defines if BGP service is enabled
        :param pulumi.Input[bool] ecmp_enabled: Defines if ECMP (Equal-cost multi-path routing) is enabled
        :param pulumi.Input[str] graceful_restart_mode: Graceful restart configuration on Edge Gateway. One of 'DISABLE', 'HELPER_ONLY', 'GRACEFUL_AND_HELPER'
        :param pulumi.Input[int] graceful_restart_timer: Maximum time taken (in seconds) for a BGP session to be established after a restart
        :param pulumi.Input[str] local_as_number: Autonomous system number
        ...
        :param pulumi.Input[int] stale_route_timer: Maximum time (in seconds) before stale routes are removed when BGP restarts
        """
