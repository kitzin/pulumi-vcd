...
class VappAccessControlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] shared_with_everyone: Whether the vApp is shared with everyone
        :param pulumi.Input[str] vapp_id: vApp identifier
        :param pulumi.Input[str] everyone_access_level: Access level when the vApp is shared with everyone (one of ReadOnly, Change, FullControl). Required when
...
class VappAccessControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 org: Optional[pulumi.Input[str]] = None,
                 shared_with_everyone: Optional[pulumi.Input[bool]] = None,
                 shared_withs: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VappAccessControlSharedWithArgs']]]]] = None,
                 vapp_id: Optional[pulumi.Input[str]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
