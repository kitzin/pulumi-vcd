...
class NsxvIpSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ip_addresses: A set of IP address, CIDR, IP range objects
        :param pulumi.Input[str] description: IP set description
        :param pulumi.Input[bool] is_inheritance_allowed: Allows visibility in underlying scopes (Default is true)
        :param pulumi.Input[str] name: IP set name
