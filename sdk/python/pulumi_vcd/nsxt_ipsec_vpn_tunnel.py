...
class NsxtIpsecVpnTunnelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] edge_gateway_id: Edge gateway name in which IP Sec VPN configuration is located
        :param pulumi.Input[str] local_ip_address: IPv4 Address for the endpoint. This has to be a sub-allocated IP on the Edge Gateway.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] local_networks: Set of local networks in CIDR format. At least one value is required
        :param pulumi.Input[str] pre_shared_key: Pre-Shared Key (PSK)
        :param pulumi.Input[str] remote_ip_address: Public IPv4 Address of the remote device terminating the VPN connection
        :param pulumi.Input[str] description: Description IP Sec VPN Tunnel
        :param pulumi.Input[bool] enabled: Enables or disables this configuration (default true)
        :param pulumi.Input[bool] logging: Sets whether logging for the tunnel is enabled or not. (default - false)
        :param pulumi.Input[str] name: Name of IP Sec VPN Tunnel
        ...
        :param pulumi.Input['NsxtIpsecVpnTunnelSecurityProfileCustomizationArgs'] security_profile_customization: Security profile customization
...
class _NsxtIpsecVpnTunnelState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] remote_ip_address: Public IPv4 Address of the remote device terminating the VPN connection
        :param pulumi.Input[Sequence[pulumi.Input[str]]] remote_networks: Set of remote networks in CIDR format. Leaving it empty is interpreted as 0.0.0.0/0
        :param pulumi.Input[str] security_profile: Security type which is use for IPsec VPN Tunnel. It will be 'DEFAULT' if nothing is customized and 'CUSTOM' if some
               changes are applied
        :param pulumi.Input['NsxtIpsecVpnTunnelSecurityProfileCustomizationArgs'] security_profile_customization: Security profile customization
...
class NsxtIpsecVpnTunnel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 remote_ip_address: Optional[pulumi.Input[str]] = None,
                 remote_networks: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 security_profile_customization: Optional[pulumi.Input[pulumi.InputType['NsxtIpsecVpnTunnelSecurityProfileCustomizationArgs']]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] remote_ip_address: Public IPv4 Address of the remote device terminating the VPN connection
        :param pulumi.Input[Sequence[pulumi.Input[str]]] remote_networks: Set of remote networks in CIDR format. Leaving it empty is interpreted as 0.0.0.0/0
        :param pulumi.Input[pulumi.InputType['NsxtIpsecVpnTunnelSecurityProfileCustomizationArgs']] security_profile_customization: Security profile customization
        :param pulumi.Input[str] vdc: The name of VDC to use, optional if defined at provider level
        """
        ...
    @overload
