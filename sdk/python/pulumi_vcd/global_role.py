...
class GlobalRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: Global role description
        :param pulumi.Input[bool] publish_to_all_tenants: When true, publishes the global role to all tenants
        :param pulumi.Input[str] name: Name of global role.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] rights: list of rights assigned to this global role
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tenants: list of tenants to which this global role is published
        """
