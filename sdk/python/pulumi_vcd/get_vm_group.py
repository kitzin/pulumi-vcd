...
def get_vm_group(name: Optional[str] = None,
    ...
    return AwaitableGetVmGroupResult(
        cluster_moref=__ret__.cluster_moref,
        cluster_name=__ret__.cluster_name,
        id=__ret__.id,
        name=__ret__.name,
        named_vm_group_id=__ret__.named_vm_group_id,
        provider_vdc_id=__ret__.provider_vdc_id,
        vcenter_id=__ret__.vcenter_id)


@_utilities.lift_output_func(get_vm_group)
def get_vm_group_output(name: Optional[pulumi.Input[str]] = None,
                        provider_vdc_id: Optional[pulumi.Input[str]] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetVmGroupResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
