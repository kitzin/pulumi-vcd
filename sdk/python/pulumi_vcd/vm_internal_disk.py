...
class VmInternalDiskInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] bus_type: The type of disk controller. Possible values: ide, parallel( LSI Logic Parallel SCSI), sas(LSI Logic SAS (SCSI)),
        ...
        :param pulumi.Input[bool] allow_vm_reboot: Powers off VM when changing any attribute of an IDE disk or unit/bus number of other disk types, after the change is
               complete VM is powered back on. Without this setting enabled, such changes on a powered-on VM would fail.
        :param pulumi.Input[int] iops: Specifies the IOPS for the disk.
