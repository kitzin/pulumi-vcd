...
class NsxtDistributedFirewallArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NsxtDistributedFirewallRuleArgs']]] rules: Ordered list of firewall rules
        :param pulumi.Input[str] vdc_group_id: ID of VDC Group for Distributed Firewall
...
class NsxtDistributedFirewall(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 org: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtDistributedFirewallRuleArgs']]]]] = None,
                 vdc_group_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtDistributedFirewallRuleArgs']]]] rules: Ordered list of firewall rules
        :param pulumi.Input[str] vdc_group_id: ID of VDC Group for Distributed Firewall
        """
        ...
    @overload
