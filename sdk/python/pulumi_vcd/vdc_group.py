...
class VdcGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] participating_vdc_ids: Participating VDC IDs
        :param pulumi.Input[str] starting_vdc_id: Starting VDC ID
        :param pulumi.Input[bool] default_policy_status: Default Policy Status
        :param pulumi.Input[str] description: VDC group description
        :param pulumi.Input[bool] dfw_enabled: Distributed firewall status
        :param pulumi.Input[str] name: Name of VDC group
...
class _VdcGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[Sequence[pulumi.Input['VdcGroupParticipatingOrgVdcArgs']]] participating_org_vdcs: The list of organization VDCs that are participating in this group
        :param pulumi.Input[Sequence[pulumi.Input[str]]] participating_vdc_ids: Participating VDC IDs
        :param pulumi.Input[str] starting_vdc_id: Starting VDC ID
        :param pulumi.Input[str] status: The status that the group can be in (e.g. 'SAVING', 'SAVED', 'CONFIGURING', 'REALIZED', 'REALIZATION_FAILED',
...
class VdcGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_provider_type: Optional[pulumi.Input[str]] = None,
            org: Optional[pulumi.Input[str]] = None,
            participating_org_vdcs: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VdcGroupParticipatingOrgVdcArgs']]]]] = None,
            participating_vdc_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            starting_vdc_id: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VdcGroupParticipatingOrgVdcArgs']]]] participating_org_vdcs: The list of organization VDCs that are participating in this group
        :param pulumi.Input[Sequence[pulumi.Input[str]]] participating_vdc_ids: Participating VDC IDs
        :param pulumi.Input[str] starting_vdc_id: Starting VDC ID
        :param pulumi.Input[str] status: The status that the group can be in (e.g. 'SAVING', 'SAVED', 'CONFIGURING', 'REALIZED', 'REALIZATION_FAILED',
               'DELETING', 'DELETE_FAILED', 'OBJECT_NOT_FOUND', 'UNCONFIGURED')
