...
class OrgGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] provider_type: Identity provider type - 'SAML' or 'INTEGRATED' for LDAP
        :param pulumi.Input[str] role: Existing role name to assign
...
class _OrgGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] provider_type: Identity provider type - 'SAML' or 'INTEGRATED' for LDAP
        :param pulumi.Input[str] role: Existing role name to assign
        :param pulumi.Input[Sequence[pulumi.Input[str]]] user_names: Read only. Set of user names that belong to the group
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if name is not None:
