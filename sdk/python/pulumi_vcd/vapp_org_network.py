...
class VappOrgNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] org_network_name: Organization network name to which vApp network is connected to
        :param pulumi.Input[str] vapp_name: vApp network name
        :param pulumi.Input[bool] is_fenced: Fencing allows identical virtual machines in different vApp networks connect to organization VDC networks that are
