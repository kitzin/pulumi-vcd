...
def get_vm_placement_policy(name: Optional[str] = None,
    ...
    return AwaitableGetVmPlacementPolicyResult(
        ...
        id=__ret__.id,
        logical_vm_group_ids=__ret__.logical_vm_group_ids,
        name=__ret__.name,
        provider_vdc_id=__ret__.provider_vdc_id,
        vdc_id=__ret__.vdc_id,
        vm_group_ids=__ret__.vm_group_ids)


@_utilities.lift_output_func(get_vm_placement_policy)
def get_vm_placement_policy_output(name: Optional[pulumi.Input[str]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetVmPlacementPolicyResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
