...
class NsxtEdgegatewayBgpIpPrefixListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] edge_gateway_id: Edge gateway ID for BGP IP Prefix List Configuration
        :param pulumi.Input[Sequence[pulumi.Input['NsxtEdgegatewayBgpIpPrefixListIpPrefixArgs']]] ip_prefixes: BGP IP Prefix List entry
        :param pulumi.Input[str] description: BGP IP Prefix List description
        :param pulumi.Input[str] name: BGP IP Prefix List name
...
class NsxtEdgegatewayBgpIpPrefixList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 edge_gateway_id: Optional[pulumi.Input[str]] = None,
                 ip_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtEdgegatewayBgpIpPrefixListIpPrefixArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 org: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] description: BGP IP Prefix List description
        :param pulumi.Input[str] edge_gateway_id: Edge gateway ID for BGP IP Prefix List Configuration
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtEdgegatewayBgpIpPrefixListIpPrefixArgs']]]] ip_prefixes: BGP IP Prefix List entry
        :param pulumi.Input[str] name: BGP IP Prefix List name
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        """
