...
class NsxtRouteAdvertisementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enabled: Defines if route advertisement is active
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] subnets: Set of subnets that will be advertised to Tier-0 gateway. Empty means none
        """
