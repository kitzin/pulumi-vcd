...
class NsxtAlbEdgegatewayServiceEngineGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] edge_gateway_id: Edge Gateway ID in which ALB Service Engine Group should be located
        :param pulumi.Input[str] service_engine_group_id: Service Engine Group ID to attach to this NSX-T Edge Gateway
        :param pulumi.Input[int] max_virtual_services: Maximum number of virtual services to be used in this Service Engine Group
        ...
        :param pulumi.Input[str] reserved_virtual_services: Number of reserved virtual services for this Service Engine Group
...
class _NsxtAlbEdgegatewayServiceEngineGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] deployed_virtual_services: Number of deployed virtual services for this Service Engine Group
        :param pulumi.Input[str] edge_gateway_id: Edge Gateway ID in which ALB Service Engine Group should be located
        :param pulumi.Input[int] max_virtual_services: Maximum number of virtual services to be used in this Service Engine Group
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
