...
class NetworkRoutedArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NetworkRoutedDhcpPoolArgs']]] dhcp_pools: A range of IPs to issue to virtual machines that don't have a static IP
        ...
        :param pulumi.Input[str] gateway: The gateway of this network
        :param pulumi.Input[str] interface_type: Which interface to use (one of `internal`, `subinterface`, `distributed`)
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NetworkRoutedMetadataEntryArgs']]] metadata_entries: Metadata entries for the given Network
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NetworkRoutedStaticIpPoolArgs']]] static_ip_pools: A range of IPs permitted to be used as static IPs for virtual machines
...
class NetworkRouted(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 dhcp_pools: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkRoutedDhcpPoolArgs']]]]] = None,
                 dns1: Optional[pulumi.Input[str]] = None,
                 dns2: Optional[pulumi.Input[str]] = None,
                 dns_suffix: Optional[pulumi.Input[str]] = None,
                 edge_gateway: Optional[pulumi.Input[str]] = None,
                 ...
                 interface_type: Optional[pulumi.Input[str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 metadata_entries: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkRoutedMetadataEntryArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 netmask: Optional[pulumi.Input[str]] = None,
                 org: Optional[pulumi.Input[str]] = None,
                 shared: Optional[pulumi.Input[bool]] = None,
                 static_ip_pools: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkRoutedStaticIpPoolArgs']]]]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] description: Optional description for the network
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkRoutedDhcpPoolArgs']]]] dhcp_pools: A range of IPs to issue to virtual machines that don't have a static IP
        :param pulumi.Input[str] dns1: First DNS server to use
        :param pulumi.Input[str] dns2: Second DNS server to use
        :param pulumi.Input[str] dns_suffix: A FQDN for the virtual machines on this network
        :param pulumi.Input[str] edge_gateway: The name of the edge gateway
        ...
        :param pulumi.Input[str] interface_type: Which interface to use (one of `internal`, `subinterface`, `distributed`)
        :param pulumi.Input[Mapping[str, Any]] metadata: Key value map of metadata to assign to this network. Key and value can be any string
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkRoutedMetadataEntryArgs']]]] metadata_entries: Metadata entries for the given Network
        :param pulumi.Input[str] name: A unique name for the network
        :param pulumi.Input[str] netmask: The netmask for the new network
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[bool] shared: Defines if this network is shared between multiple VDCs in the Org
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkRoutedStaticIpPoolArgs']]]] static_ip_pools: A range of IPs permitted to be used as static IPs for virtual machines
        :param pulumi.Input[str] vdc: The name of VDC to use, optional if defined at provider level
        """
        ...
    @overload
