...
class NsxtNetworkDhcpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] org_network_id: Parent Org VDC network ID
        :param pulumi.Input[Sequence[pulumi.Input[str]]] dns_servers: The DNS server IPs to be assigned by this DHCP service. 2 values maximum.
        :param pulumi.Input[int] lease_time: Lease time in seconds
        :param pulumi.Input[str] listener_ip_address: IP Address of DHCP server in network. Only applicable when mode=NETWORK
        :param pulumi.Input[str] mode: DHCP mode. One of 'EDGE' (default), 'NETWORK', 'RELAY'
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NsxtNetworkDhcpPoolArgs']]] pools: IP ranges used for DHCP pool allocation in the network
...
class NsxtNetworkDhcp(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 org: Optional[pulumi.Input[str]] = None,
                 org_network_id: Optional[pulumi.Input[str]] = None,
                 pools: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtNetworkDhcpPoolArgs']]]]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[str] org_network_id: Parent Org VDC network ID
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtNetworkDhcpPoolArgs']]]] pools: IP ranges used for DHCP pool allocation in the network
        :param pulumi.Input[str] vdc: The name of VDC to use, optional if defined at provider level
        """
        ...
    @overload
