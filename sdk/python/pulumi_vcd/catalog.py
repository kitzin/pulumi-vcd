...
class CatalogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] cache_enabled: True enables early catalog export to optimize synchronization
        :param pulumi.Input[Mapping[str, Any]] metadata: Key and value pairs for catalog metadata.
        :param pulumi.Input[Sequence[pulumi.Input['CatalogMetadataEntryArgs']]] metadata_entries: Metadata entries for the given Catalog
        ...
        :param pulumi.Input[bool] preserve_identity_information: Include BIOS UUIDs and MAC addresses in the downloaded OVF package. Preserving the identity information limits the
               portability of the package and you should use it only when necessary.
        :param pulumi.Input[bool] publish_enabled: True allows to publish a catalog externally to make its vApp templates and media files available for subscription by
...
class _CatalogState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] cache_enabled: True enables early catalog export to optimize synchronization
        :param pulumi.Input[int] catalog_version: Catalog version number.
        ...
        :param pulumi.Input[bool] is_published: True if this catalog is published.
        ...
        :param pulumi.Input[Mapping[str, Any]] metadata: Key and value pairs for catalog metadata.
        :param pulumi.Input[Sequence[pulumi.Input['CatalogMetadataEntryArgs']]] metadata_entries: Metadata entries for the given Catalog
        :param pulumi.Input[int] number_of_media: Number of Medias this catalog contains.
        :param pulumi.Input[int] number_of_vapp_templates: Number of vApps templates this catalog contains.
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        ...
        :param pulumi.Input[bool] publish_enabled: True allows to publish a catalog externally to make its vApp templates and media files available for subscription by
               organizations outside the Cloud Director installation.
        :param pulumi.Input[str] publish_subscription_type: PUBLISHED if published externally, SUBSCRIBED if subscribed to an external catalog, UNPUBLISHED otherwise.
        :param pulumi.Input[str] publish_subscription_url: URL to which other catalogs can subscribe
        :param pulumi.Input[str] storage_profile_id: Optional storage profile ID
...
class Catalog(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 metadata_entries: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CatalogMetadataEntryArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 org: Optional[pulumi.Input[str]] = None,
                 password: Optional[pulumi.Input[str]] = None,
                 preserve_identity_information: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] delete_recursive: When destroying use delete_recursive=True to remove the catalog and any objects it contains that are in a state that
               normally allows removal.
        :param pulumi.Input[Mapping[str, Any]] metadata: Key and value pairs for catalog metadata.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CatalogMetadataEntryArgs']]]] metadata_entries: Metadata entries for the given Catalog
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[str] password: An optional password to access the catalog. Only ASCII characters are allowed in a valid password.
        :param pulumi.Input[bool] preserve_identity_information: Include BIOS UUIDs and MAC addresses in the downloaded OVF package. Preserving the identity information limits the
