...
class NsxtAlbVirtualServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] application_profile_type: HTTP, HTTPS, L4, L4_TLS
        :param pulumi.Input[str] edge_gateway_id: Edge gateway ID in which ALB Pool should be created
        :param pulumi.Input[str] pool_id: Pool ID
        :param pulumi.Input[str] service_engine_group_id: Service Engine Group ID
        :param pulumi.Input[str] virtual_ip_address: Virtual IP address (VIP) for Virtual Service
        :param pulumi.Input[str] ca_certificate_id: Optional certificate ID to use for exposing service
        :param pulumi.Input[str] description: Description of ALB Virtual Service
        :param pulumi.Input[bool] enabled: Virtual Service is enabled or disabled (default true)
        :param pulumi.Input[str] name: Name of ALB Virtual Service
...
class NsxtAlbVirtualService(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 pool_id: Optional[pulumi.Input[str]] = None,
                 service_engine_group_id: Optional[pulumi.Input[str]] = None,
                 service_ports: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtAlbVirtualServiceServicePortArgs']]]]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
                 virtual_ip_address: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
