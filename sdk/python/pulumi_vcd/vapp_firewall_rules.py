...
class VappFirewallRulesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] default_action: Specifies what to do should none of the rules match. Either `allow` or `drop`
        :param pulumi.Input[str] network_id: vApp network identifier
        :param pulumi.Input[str] vapp_id: vApp identifier
        :param pulumi.Input[bool] enabled: Enable or disable firewall service. Default is `true`
...
class VappFirewallRules(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 network_id: Optional[pulumi.Input[str]] = None,
                 org: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VappFirewallRulesRuleArgs']]]]] = None,
                 vapp_id: Optional[pulumi.Input[str]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
