...
class NsxtAppPortProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] scope: Scope - 'PROVIDER' or 'TENANT'
        :param pulumi.Input[str] context_id: ID of VDC, VDC Group, or NSX-T Manager
        :param pulumi.Input[str] description: Application Port Profile description
        :param pulumi.Input[str] name: Application Port Profile name
        :param pulumi.Input[str] nsxt_manager_id: ID of NSX-T manager. Only required for 'PROVIDER' scope
...
class NsxtAppPortProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 app_ports: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtAppPortProfileAppPortArgs']]]]] = None,
                 context_id: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 nsxt_manager_id: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if nsxt_manager_id is not None and not opts.urn:
                warnings.warn("""Deprecated in favor of 'context_id'""", DeprecationWarning)
                pulumi.log.warn("""nsxt_manager_id is deprecated: Deprecated in favor of 'context_id'""")
