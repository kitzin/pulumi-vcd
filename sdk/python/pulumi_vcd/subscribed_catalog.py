...
class SubscribedCatalogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] delete_force: When destroying use delete_force=True with delete_recursive=True to remove a catalog and any objects it contains,
               regardless of their state.
        :param pulumi.Input[bool] delete_recursive: When destroying use delete_recursive=True to remove the catalog and any objects it contains that are in a state that
               normally allows removal.
        :param pulumi.Input[bool] make_local_copy: If true, subscription to a catalog creates a local copy of all items. Defaults to false, which does not create a local
               copy of catalog items unless a sync operation is performed.
        :param pulumi.Input[str] name: The name of the catalog
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level.
        :param pulumi.Input[str] storage_profile_id: Optional storage profile ID
        :param pulumi.Input[bool] store_tasks: If true, saves list of tasks to file for later update
        :param pulumi.Input[str] subscription_password: An optional password to access the catalog. Only ASCII characters are allowed in a valid password. Passing in six
        ...
        :param pulumi.Input[bool] sync_all_media_items: If true, synchronises all media items
        :param pulumi.Input[bool] sync_all_vapp_templates: If true, synchronises all vApp templates
        :param pulumi.Input[bool] sync_catalog: If true, synchronise this catalog. This operation fetches the list of items. If `make_local_copy` is set, it also
               fetches the items data.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] sync_media_items: Synchronises media items from this list of names.
        :param pulumi.Input[bool] sync_on_refresh: Boolean value that shows if sync should be performed on every refresh.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] sync_vapp_templates: Synchronises vApp templates from this list of names.
        """
...
class _SubscribedCatalogState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] cancel_failed_tasks: When true, the subscribed catalog will attempt canceling failed tasks
        :param pulumi.Input[int] catalog_version: Catalog version number. Inherited from publishing catalog and updated on sync.
        :param pulumi.Input[str] created: Time stamp of when the catalog was created
        :param pulumi.Input[bool] delete_force: When destroying use delete_force=True with delete_recursive=True to remove a catalog and any objects it contains,
               regardless of their state.
        :param pulumi.Input[bool] delete_recursive: When destroying use delete_recursive=True to remove the catalog and any objects it contains that are in a state that
               normally allows removal.
        :param pulumi.Input[str] description: A subscribed catalog description is inherited from the publisher catalog and cannot be changed. It is updated on sync
        :param pulumi.Input[Sequence[pulumi.Input[str]]] failed_tasks: List of failed synchronization tasks
        :param pulumi.Input[str] href: Catalog HREF
        :param pulumi.Input[bool] is_local: True if this catalog belongs to the current organization.
        :param pulumi.Input[bool] is_published: True if this catalog is published. (Always false)
        :param pulumi.Input[bool] is_shared: True if this catalog is shared.
        :param pulumi.Input[bool] make_local_copy: If true, subscription to a catalog creates a local copy of all items. Defaults to false, which does not create a local
               copy of catalog items unless a sync operation is performed.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] media_item_lists: List of Media items in this catalog
        :param pulumi.Input[Mapping[str, Any]] metadata: Key and value pairs for catalog metadata. Inherited from publishing catalog
        :param pulumi.Input[str] name: The name of the catalog
        :param pulumi.Input[int] number_of_media: Number of Media items this catalog contains.
        :param pulumi.Input[int] number_of_vapp_templates: Number of vApp templates this catalog contains.
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level.
        :param pulumi.Input[str] owner_name: Owner name from the catalog.
        :param pulumi.Input[str] publish_subscription_type: PUBLISHED if published externally, SUBSCRIBED if subscribed to an external catalog, UNPUBLISHED otherwise. (Always
               SUBSCRIBED)
        :param pulumi.Input[Sequence[pulumi.Input[str]]] running_tasks: List of running synchronization tasks
        :param pulumi.Input[str] storage_profile_id: Optional storage profile ID
        :param pulumi.Input[bool] store_tasks: If true, saves list of tasks to file for later update
        :param pulumi.Input[str] subscription_password: An optional password to access the catalog. Only ASCII characters are allowed in a valid password. Passing in six
               asterisks '******' indicates to keep current password. Passing in null or empty string indicates to remove password.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] vapp_template_lists: List of catalog items in this catalog
        """
        if cancel_failed_tasks is not None:
            pulumi.set(__self__, "cancel_failed_tasks", cancel_failed_tasks)
