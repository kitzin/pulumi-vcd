...
class NsxvDnatArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] edge_gateway: Edge gateway name in which NAT Rule is located
        :param pulumi.Input[str] network_name: Org or external network name
        :param pulumi.Input[str] network_type: Network type. One of 'ext', 'org'
        :param pulumi.Input[str] original_address: Original address or address range. This is the the destination address for DNAT rules.
        :param pulumi.Input[str] description: NAT rule description
        :param pulumi.Input[bool] enabled: Whether the rule should be enabled. Default 'true'
        :param pulumi.Input[str] icmp_type: ICMP type. Only supported when protocol is ICMP. One of `any`, `address-mask-request`, `address-mask-reply`,
        ...
        :param pulumi.Input[str] original_port: Original port. This is the destination port for DNAT rules
        :param pulumi.Input[str] protocol: Protocol. Such as 'tcp', 'udp', 'icmp', 'any'
        ...
        :param pulumi.Input[str] translated_address: Translated address or address range
        :param pulumi.Input[str] translated_port: Translated port
