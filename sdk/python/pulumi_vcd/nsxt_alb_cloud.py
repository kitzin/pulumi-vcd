...
class NsxtAlbCloudArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] controller_id: NSX-T ALB Controller ID
        :param pulumi.Input[str] importable_cloud_id: NSX-T ALB Importable Cloud ID
        :param pulumi.Input[str] network_pool_id: Network pool ID for NSX-T ALB Importable Cloud
        :param pulumi.Input[str] description: NSX-T ALB Cloud description
        :param pulumi.Input[str] name: NSX-T ALB Cloud name
        """
...
class _NsxtAlbCloudState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] controller_id: NSX-T ALB Controller ID
        :param pulumi.Input[str] description: NSX-T ALB Cloud description
        :param pulumi.Input[str] health_message: NSX-T ALB Cloud detailed health message
        :param pulumi.Input[str] health_status: NSX-T ALB Cloud health status
        :param pulumi.Input[str] importable_cloud_id: NSX-T ALB Importable Cloud ID
        :param pulumi.Input[str] name: NSX-T ALB Cloud name
        :param pulumi.Input[str] network_pool_id: Network pool ID for NSX-T ALB Importable Cloud
        :param pulumi.Input[str] network_pool_name: Network pool name of NSX-T ALB Cloud
        """
