...
def get_nsxv_dnat(edge_gateway: Optional[str] = None,
    ...
    return AwaitableGetNsxvDnatResult(
        ...
        org=__ret__.org,
        original_address=__ret__.original_address,
        original_port=__ret__.original_port,
        protocol=__ret__.protocol,
        rule_id=__ret__.rule_id,
        rule_tag=__ret__.rule_tag,
        rule_type=__ret__.rule_type,
        translated_address=__ret__.translated_address,
        translated_port=__ret__.translated_port,
        vdc=__ret__.vdc)


@_utilities.lift_output_func(get_nsxv_dnat)
def get_nsxv_dnat_output(edge_gateway: Optional[pulumi.Input[str]] = None,
                         org: Optional[pulumi.Input[Optional[str]]] = None,
                         rule_id: Optional[pulumi.Input[str]] = None,
                         vdc: Optional[pulumi.Input[Optional[str]]] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNsxvDnatResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
