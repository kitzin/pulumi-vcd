...
class NsxtAlbControllerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] password: NSX-T ALB Controller Password
        :param pulumi.Input[str] url: NSX-T ALB Controller URL
        :param pulumi.Input[str] username: NSX-T ALB Controller Username
        :param pulumi.Input[str] description: NSX-T ALB Controller description
        :param pulumi.Input[str] license_type: NSX-T ALB License type. One of 'BASIC', 'ENTERPRISE'. Must not be used from VCD 10.4.0 onwards
        :param pulumi.Input[str] name: NSX-T ALB Controller name
        """
...
class _NsxtAlbControllerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] url: NSX-T ALB Controller URL
        :param pulumi.Input[str] username: NSX-T ALB Controller Username
        :param pulumi.Input[str] version: NSX-T ALB Controller version
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if license_type is not None:
