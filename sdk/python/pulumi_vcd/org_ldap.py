...
class OrgLdapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] ldap_mode: Type of LDAP settings (one of NONE, SYSTEM, CUSTOM)
        :param pulumi.Input[str] org_id: Organization ID
        :param pulumi.Input['OrgLdapCustomSettingsArgs'] custom_settings: Custom settings when `ldap_mode` is CUSTOM
        """
...
class OrgLdap(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 custom_settings: Optional[pulumi.Input[pulumi.InputType['OrgLdapCustomSettingsArgs']]] = None,
                 ldap_mode: Optional[pulumi.Input[str]] = None,
                 org_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['OrgLdapCustomSettingsArgs']] custom_settings: Custom settings when `ldap_mode` is CUSTOM
        :param pulumi.Input[str] ldap_mode: Type of LDAP settings (one of NONE, SYSTEM, CUSTOM)
        :param pulumi.Input[str] org_id: Organization ID
        """
        ...
