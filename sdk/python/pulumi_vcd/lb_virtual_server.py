...
class LbVirtualServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] edge_gateway: Edge gateway name in which the LB Virtual Server is located
        :param pulumi.Input[str] ip_address: IP address that the load balancer listens on
        :param pulumi.Input[int] port: Port number that the load balancer listens on
        :param pulumi.Input[str] protocol: Protocol that the virtual server accepts
        ...
        :param pulumi.Input[bool] enable_acceleration: Enable virtual server acceleration
        :param pulumi.Input[bool] enabled: Defines if the virtual server is enabled
        :param pulumi.Input[str] name: Unique Virtual Server name
