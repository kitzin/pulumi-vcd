...
class NsxtEdgegatewayBgpNeighborArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] edge_gateway_id: Edge gateway ID for BGP Neighbor Configuration
        :param pulumi.Input[str] ip_address: BGP Neighbor IP address (IPv4 or IPv6)
        :param pulumi.Input[str] remote_as_number: Remote Autonomous System (AS) number
        :param pulumi.Input[bool] allow_as_in: A flag indicating whether BGP neighbors can receive routes with same Autonomous System (AS) (default 'false')
        ...
        :param pulumi.Input[bool] bfd_enabled: BFD configuration for failure detection
        :param pulumi.Input[int] bfd_interval: Time interval (in milliseconds) between heartbeat packets
        :param pulumi.Input[str] graceful_restart_mode: One of 'DISABLE', 'HELPER_ONLY', 'GRACEFUL_AND_HELPER'
        :param pulumi.Input[int] hold_down_timer: Time interval (in seconds) before declaring a peer dead
        :param pulumi.Input[str] in_filter_ip_prefix_list_id: An optional IP Prefix List ID for filtering 'IN' direction.
        :param pulumi.Input[int] keep_alive_timer: Time interval (in seconds) between sending keep alive messages to a peer
        ...
        :param pulumi.Input[str] out_filter_ip_prefix_list_id: An optional IP Prefix List ID for filtering 'OUT' direction.
        :param pulumi.Input[str] password: Neighbor password
        :param pulumi.Input[str] route_filtering: One of 'DISABLED', 'IPV4', 'IPV6'
        """
