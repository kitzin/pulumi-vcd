...
def get_nsxt_alb_service_engine_group(name: Optional[str] = None,
    ...
    return AwaitableGetNsxtAlbServiceEngineGroupResult(
        alb_cloud_id=__ret__.alb_cloud_id,
        ...
        name=__ret__.name,
        overallocated=__ret__.overallocated,
        reservation_model=__ret__.reservation_model,
        reserved_virtual_services=__ret__.reserved_virtual_services,
        supported_feature_set=__ret__.supported_feature_set,
        sync_on_refresh=__ret__.sync_on_refresh)


@_utilities.lift_output_func(get_nsxt_alb_service_engine_group)
def get_nsxt_alb_service_engine_group_output(name: Optional[pulumi.Input[str]] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNsxtAlbServiceEngineGroupResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
