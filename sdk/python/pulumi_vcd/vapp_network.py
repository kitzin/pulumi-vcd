...
class VappNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] vapp_name: vApp to use
        :param pulumi.Input[str] description: Optional description for the network
        :param pulumi.Input[Sequence[pulumi.Input['VappNetworkDhcpPoolArgs']]] dhcp_pools: A range of IPs to issue to virtual machines that don't have a static IP
        ...
        :param pulumi.Input[str] name: vApp network name
        :param pulumi.Input[str] netmask: Netmask address for a subnet. Default is 255.255.255.0
        ...
        :param pulumi.Input[str] org_network_name: org network name to which vapp network is connected
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VappNetworkStaticIpPoolArgs']]] static_ip_pools: A range of IPs permitted to be used as static IPs for virtual machines
...
class VappNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 dhcp_pools: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VappNetworkDhcpPoolArgs']]]]] = None,
                 dns1: Optional[pulumi.Input[str]] = None,
                 dns2: Optional[pulumi.Input[str]] = None,
                 dns_suffix: Optional[pulumi.Input[str]] = None,
                 gateway: Optional[pulumi.Input[str]] = None,
                 ...
                 org_network_name: Optional[pulumi.Input[str]] = None,
                 retain_ip_mac_enabled: Optional[pulumi.Input[bool]] = None,
                 static_ip_pools: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VappNetworkStaticIpPoolArgs']]]]] = None,
                 vapp_name: Optional[pulumi.Input[str]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] description: Optional description for the network
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VappNetworkDhcpPoolArgs']]]] dhcp_pools: A range of IPs to issue to virtual machines that don't have a static IP
        :param pulumi.Input[str] dns1: Primary DNS server
        :param pulumi.Input[str] dns2: Secondary DNS server
        :param pulumi.Input[str] dns_suffix: DNS suffix
        :param pulumi.Input[str] gateway: Gateway of the network
        ...
        :param pulumi.Input[str] org_network_name: org network name to which vapp network is connected
        :param pulumi.Input[bool] retain_ip_mac_enabled: Specifies whether the network resources such as IP/MAC of router will be retained across deployments. Default is false.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VappNetworkStaticIpPoolArgs']]]] static_ip_pools: A range of IPs permitted to be used as static IPs for virtual machines
        :param pulumi.Input[str] vapp_name: vApp to use
        :param pulumi.Input[str] vdc: The name of VDC to use, optional if defined at provider level
        """
        ...
