...
class NsxtAlbPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] edge_gateway_id: Edge gateway ID in which ALB Pool should be created
        :param pulumi.Input[str] algorithm: Algorithm for choosing pool members (default LEAST_CONNECTIONS). Other `ROUND_ROBIN`,`CONSISTENT_HASH`,
               `FASTEST_RESPONSE`, `LEAST_LOAD`, `FEWEST_SERVERS`, `RANDOM`, `FEWEST_TASKS`,`CORE_AFFINITY`
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ca_certificate_ids: A set of root certificate IDs to use when validating certificates presented by pool members
        :param pulumi.Input[bool] cn_check_enabled: Boolean flag if common name check of the certificate should be enabled
        :param pulumi.Input[int] default_port: Default Port defines destination server port used by the traffic sent to the member (default 80)
        :param pulumi.Input[str] description: Description of ALB Pool
        :param pulumi.Input[Sequence[pulumi.Input[str]]] domain_names: List of domain names which will be used to verify common names
        :param pulumi.Input[bool] enabled: Boolean value if ALB Pool is enabled or not (default true)
        :param pulumi.Input[int] graceful_timeout_period: Maximum time in minutes to gracefully disable pool member (default 1)
        :param pulumi.Input[Sequence[pulumi.Input['NsxtAlbPoolMemberArgs']]] members: ALB Pool Members
        :param pulumi.Input[str] name: Name of ALB Pool
        ...
        :param pulumi.Input[bool] passive_monitoring_enabled: Monitors if the traffic is accepted by node (default true)
...
class _NsxtAlbPoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] algorithm: Algorithm for choosing pool members (default LEAST_CONNECTIONS). Other `ROUND_ROBIN`,`CONSISTENT_HASH`,
               `FASTEST_RESPONSE`, `LEAST_LOAD`, `FEWEST_SERVERS`, `RANDOM`, `FEWEST_TASKS`,`CORE_AFFINITY`
        :param pulumi.Input[Sequence[pulumi.Input[str]]] associated_virtual_service_ids: IDs of associated virtual services
        :param pulumi.Input[Sequence[pulumi.Input[str]]] associated_virtual_services: Names of associated virtual services
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ca_certificate_ids: A set of root certificate IDs to use when validating certificates presented by pool members
        :param pulumi.Input[bool] cn_check_enabled: Boolean flag if common name check of the certificate should be enabled
        :param pulumi.Input[int] default_port: Default Port defines destination server port used by the traffic sent to the member (default 80)
        :param pulumi.Input[str] description: Description of ALB Pool
        ...
        :param pulumi.Input[str] edge_gateway_id: Edge gateway ID in which ALB Pool should be created
        :param pulumi.Input[bool] enabled: Boolean value if ALB Pool is enabled or not (default true)
        :param pulumi.Input[int] enabled_member_count: Number of enabled members in the pool
        :param pulumi.Input[int] graceful_timeout_period: Maximum time in minutes to gracefully disable pool member (default 1)
        :param pulumi.Input[str] health_message: Health message
        :param pulumi.Input[int] member_count: Number of members in the pool
        :param pulumi.Input[Sequence[pulumi.Input['NsxtAlbPoolMemberArgs']]] members: ALB Pool Members
        :param pulumi.Input[str] name: Name of ALB Pool
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[bool] passive_monitoring_enabled: Monitors if the traffic is accepted by node (default true)
        :param pulumi.Input[int] up_member_count: Number of members in the pool serving the traffic
        :param pulumi.Input[str] vdc: The name of VDC to use, optional if defined at provider level
        """
        if algorithm is not None:
            pulumi.set(__self__, "algorithm", algorithm)
...
class NsxtAlbPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 enabled: Optional[pulumi.Input[bool]] = None,
                 graceful_timeout_period: Optional[pulumi.Input[int]] = None,
                 health_monitors: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtAlbPoolHealthMonitorArgs']]]]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtAlbPoolMemberArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 org: Optional[pulumi.Input[str]] = None,
                 passive_monitoring_enabled: Optional[pulumi.Input[bool]] = None,
                 persistence_profile: Optional[pulumi.Input[pulumi.InputType['NsxtAlbPoolPersistenceProfileArgs']]] = None,
                 vdc: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[bool] enabled: Boolean value if ALB Pool is enabled or not (default true)
        :param pulumi.Input[int] graceful_timeout_period: Maximum time in minutes to gracefully disable pool member (default 1)
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NsxtAlbPoolMemberArgs']]]] members: ALB Pool Members
        :param pulumi.Input[str] name: Name of ALB Pool
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[bool] passive_monitoring_enabled: Monitors if the traffic is accepted by node (default true)
