...
class OrgUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role: Role within the organization
        ...
        :param pulumi.Input[str] description: The user's description
        :param pulumi.Input[str] email_address: The user's email address
        :param pulumi.Input[bool] enabled: True if the user is enabled and can log in.
        :param pulumi.Input[str] full_name: The user's full name
        :param pulumi.Input[str] instant_messaging: The user's telephone
        :param pulumi.Input[bool] is_external: True if this user is imported from an external resource, like an LDAP.
        :param pulumi.Input[bool] is_group_role: True if this user has a group role.
        :param pulumi.Input[bool] is_locked: If the user account has been locked due to too many invalid login attempts, the value will change to true (only the
               system can lock the user). To unlock the user re-set this flag to false.
        :param pulumi.Input[str] name: User's name. Only lowercase letters allowed. Cannot be changed after creation
        ...
        :param pulumi.Input[str] password_file: Name of a file containing the user's password. Either "password_file" or "password" must be included on creation unless
               is_external is true.
        :param pulumi.Input[str] provider_type: Identity provider type for this this user. One of: 'INTEGRATED', 'SAML', 'OAUTH'. When empty, the default value
               'INTEGRATED' is used.
        ...
        :param pulumi.Input[str] telephone: The user's telephone
        """
...
class _OrgUserState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enabled: True if the user is enabled and can log in.
        :param pulumi.Input[str] full_name: The user's full name
        :param pulumi.Input[Sequence[pulumi.Input[str]]] group_names: Read only. Set of group names that this user belongs to
        :param pulumi.Input[str] instant_messaging: The user's telephone
        :param pulumi.Input[bool] is_external: True if this user is imported from an external resource, like an LDAP.
        :param pulumi.Input[bool] is_group_role: True if this user has a group role.
        :param pulumi.Input[bool] is_locked: If the user account has been locked due to too many invalid login attempts, the value will change to true (only the
