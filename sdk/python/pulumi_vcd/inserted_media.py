...
class InsertedMediaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] catalog: catalog name where to find media file
        :param pulumi.Input[str] vapp_name: vApp to use
        :param pulumi.Input[str] vm_name: VM in vApp in which media will be inserted or ejected
        :param pulumi.Input[bool] eject_force: When ejecting answers automatically to question yes
        :param pulumi.Input[str] name: media name to use
...
class InsertedMedia(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a InsertedMedia resource with the given unique name, props, and options.
