...
class LbAppRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] edge_gateway: Edge gateway name in which the LB Application Rule is located
        ...
        :param pulumi.Input[str] name: Unique LB Application Rule name
