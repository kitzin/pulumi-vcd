...
class NsxtAlbServiceEngineGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] alb_cloud_id: NSX-T ALB backing Cloud ID
        :param pulumi.Input[str] importable_service_engine_group_name: NSX-T ALB Importable Service Engine Group Name
        :param pulumi.Input[str] reservation_model: NSX-T ALB Service Engine Group reservation model. One of 'DEDICATED', 'SHARED'
        :param pulumi.Input[str] description: NSX-T ALB Service Engine Group description
        :param pulumi.Input[str] name: NSX-T ALB Service Engine Group name
        :param pulumi.Input[bool] overallocated: Boolean value that shows if virtual services are overallocated
        :param pulumi.Input[str] supported_feature_set: Feature set for this ALB Service Engine Group. One of 'STANDARD', 'PREMIUM'.
...
class _NsxtAlbServiceEngineGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] alb_cloud_id: NSX-T ALB backing Cloud ID
        :param pulumi.Input[int] deployed_virtual_services: NSX-T ALB Service Engine Group deployed virtual services
        :param pulumi.Input[str] description: NSX-T ALB Service Engine Group description
        :param pulumi.Input[str] ha_mode: NSX-T ALB Service Engine Group HA mode
        :param pulumi.Input[str] importable_service_engine_group_name: NSX-T ALB Importable Service Engine Group Name
        :param pulumi.Input[int] max_virtual_services: NSX-T ALB Service Engine Group maximum virtual services
        :param pulumi.Input[str] name: NSX-T ALB Service Engine Group name
        :param pulumi.Input[bool] overallocated: Boolean value that shows if virtual services are overallocated
        :param pulumi.Input[str] reservation_model: NSX-T ALB Service Engine Group reservation model. One of 'DEDICATED', 'SHARED'
        :param pulumi.Input[int] reserved_virtual_services: NSX-T ALB Service Engine Group reserved virtual services
        :param pulumi.Input[str] supported_feature_set: Feature set for this ALB Service Engine Group. One of 'STANDARD', 'PREMIUM'.
        :param pulumi.Input[bool] sync_on_refresh: Boolean value that shows if sync should be performed on every refresh
        """
