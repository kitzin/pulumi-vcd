...
class RightsBundleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: Rights bundle description
        :param pulumi.Input[bool] publish_to_all_tenants: When true, publishes the rights bundle to all tenants
        :param pulumi.Input[str] name: Name of rights bundle.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] rights: Set of rights assigned to this rights bundle
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tenants: Set of tenants to which this rights bundle is published
        """
