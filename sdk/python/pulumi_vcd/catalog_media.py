...
class CatalogMediaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] media_path: absolute or relative path to Media file
        :param pulumi.Input[str] catalog: catalog name where to upload the Media file
        :param pulumi.Input[str] catalog_id: ID of the catalog where to upload the Media file
        :param pulumi.Input[Mapping[str, Any]] metadata: Key and value pairs for catalog item metadata
        :param pulumi.Input[Sequence[pulumi.Input['CatalogMediaMetadataEntryArgs']]] metadata_entries: Metadata entries for the given Catalog Media
        :param pulumi.Input[str] name: media name
    ...
    def media_path(self) -> pulumi.Input[str]:
        """
    ...
    @media_path.setter
    def media_path(self, value: pulumi.Input[str]):
...
class _CatalogMediaState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] catalog: catalog name where to upload the Media file
        :param pulumi.Input[str] catalog_id: ID of the catalog where to upload the Media file
        :param pulumi.Input[str] creation_date: Creation date
        :param pulumi.Input[bool] is_iso: True if this media file is ISO
        :param pulumi.Input[bool] is_published: True if this media file is in a published catalog
        :param pulumi.Input[str] media_path: absolute or relative path to Media file
        :param pulumi.Input[Mapping[str, Any]] metadata: Key and value pairs for catalog item metadata
        :param pulumi.Input[Sequence[pulumi.Input['CatalogMediaMetadataEntryArgs']]] metadata_entries: Metadata entries for the given Catalog Media
        :param pulumi.Input[str] name: media name
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[str] owner_name: Owner name
        :param pulumi.Input[bool] show_upload_progress: shows upload progress in stdout
        :param pulumi.Input[int] size: Media storage in Bytes
        :param pulumi.Input[str] status: Media status
        :param pulumi.Input[str] storage_profile_name: Storage profile name
        :param pulumi.Input[int] upload_piece_size: size of upload file piece size in mega bytes
        """
        if catalog is not None:
            warnings.warn("""Use catalog_id instead""", DeprecationWarning)
...
class CatalogMedia(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 media_path: Optional[pulumi.Input[str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 metadata_entries: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CatalogMediaMetadataEntryArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 org: Optional[pulumi.Input[str]] = None,
                 show_upload_progress: Optional[pulumi.Input[bool]] = None,
                 upload_piece_size: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[str] media_path: absolute or relative path to Media file
        :param pulumi.Input[Mapping[str, Any]] metadata: Key and value pairs for catalog item metadata
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CatalogMediaMetadataEntryArgs']]]] metadata_entries: Metadata entries for the given Catalog Media
        :param pulumi.Input[str] name: media name
        :param pulumi.Input[str] org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across
               different organizations
        :param pulumi.Input[bool] show_upload_progress: shows upload progress in stdout
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if catalog is not None and not opts.urn:
                warnings.warn("""Use catalog_id instead""", DeprecationWarning)
                pulumi.log.warn("""catalog is deprecated: Use catalog_id instead""")
            __props__.__dict__["catalog"] = catalog
            __props__.__dict__["catalog_id"] = catalog_id
            __props__.__dict__["description"] = description
            if media_path is None and not opts.urn:
                raise TypeError("Missing required property 'media_path'")
    ...
    @property
    @pulumi.getter(name="mediaPath")
    def media_path(self) -> pulumi.Output[str]:
        """
        absolute or relative path to Media file
        """
        return pulumi.get(self, "media_path")
