...
class GetNetworkIsolatedV2Result:
    ...
    """
    def __init__(__self__, description=None, dns1=None, dns2=None, dns_suffix=None, filter=None, gateway=None, id=None, is_shared=None, metadata=None, metadata_entries=None, name=None, org=None, owner_id=None, prefix_length=None, static_ip_pools=None, vdc=None):
...
def get_network_isolated_v2(filter: Optional[pulumi.InputType['GetNetworkIsolatedV2FilterArgs']] = None,
...
@_utilities.lift_output_func(get_network_isolated_v2)
def get_network_isolated_v2_output(filter: Optional[pulumi.Input[Optional[pulumi.InputType['GetNetworkIsolatedV2FilterArgs']]]] = None,
                                   name: Optional[pulumi.Input[Optional[str]]] = None,
                                   org: Optional[pulumi.Input[Optional[str]]] = None,
                                   owner_id: Optional[pulumi.Input[Optional[str]]] = None,
                                   vdc: Optional[pulumi.Input[Optional[str]]] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNetworkIsolatedV2Result]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
