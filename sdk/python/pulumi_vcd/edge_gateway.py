...
class EdgeGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] configuration: Configuration of the vShield edge VM for this gateway. One of: compact, full ("Large"), full4 ("Quad Large"), x-large
        :param pulumi.Input[Sequence[pulumi.Input['EdgeGatewayExternalNetworkArgs']]] external_networks: One or more blocks with external network information to be attached to this gateway's interface
        :param pulumi.Input[bool] distributed_routing: Enable distributed routing
        :param pulumi.Input[bool] fips_mode_enabled: Enable FIPS mode. FIPS mode turns on the cipher suites that comply with FIPS. (False by default)
        ...
        :param pulumi.Input[bool] ha_enabled: Enable high availability on this edge gateway
        ...
        :param pulumi.Input[bool] use_default_route_for_dns_relay: If true, default gateway will be used for the edge gateways' default routing and DNS forwarding.(False by default)
...
class _EdgeGatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] configuration: Configuration of the vShield edge VM for this gateway. One of: compact, full ("Large"), full4 ("Quad Large"), x-large
        :param pulumi.Input[str] default_external_network_ip: IP address of edge gateway interface which is used as default.
        :param pulumi.Input[bool] distributed_routing: Enable distributed routing
        :param pulumi.Input[Sequence[pulumi.Input[str]]] external_network_ips: List of IP addresses set on edge gateway external network interfaces
        :param pulumi.Input[Sequence[pulumi.Input['EdgeGatewayExternalNetworkArgs']]] external_networks: One or more blocks with external network information to be attached to this gateway's interface
        :param pulumi.Input[bool] fips_mode_enabled: Enable FIPS mode. FIPS mode turns on the cipher suites that comply with FIPS. (False by default)
        :param pulumi.Input[str] fw_default_rule_action: 'accept' or 'deny'. Default 'deny'
        :param pulumi.Input[bool] fw_default_rule_logging_enabled: Enable logging for default rule. Default 'false'
...
class EdgeGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 distributed_routing: Optional[pulumi.Input[bool]] = None,
                 external_networks: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EdgeGatewayExternalNetworkArgs']]]]] = None,
                 fips_mode_enabled: Optional[pulumi.Input[bool]] = None,
                 fw_default_rule_action: Optional[pulumi.Input[str]] = None,
                 fw_default_rule_logging_enabled: Optional[pulumi.Input[bool]] = None,
                 fw_enabled: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[str] configuration: Configuration of the vShield edge VM for this gateway. One of: compact, full ("Large"), full4 ("Quad Large"), x-large
        :param pulumi.Input[bool] distributed_routing: Enable distributed routing
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EdgeGatewayExternalNetworkArgs']]]] external_networks: One or more blocks with external network information to be attached to this gateway's interface
        :param pulumi.Input[bool] fips_mode_enabled: Enable FIPS mode. FIPS mode turns on the cipher suites that comply with FIPS. (False by default)
        :param pulumi.Input[str] fw_default_rule_action: 'accept' or 'deny'. Default 'deny'
        :param pulumi.Input[bool] fw_default_rule_logging_enabled: Enable logging for default rule. Default 'false'
        :param pulumi.Input[bool] fw_enabled: Enable firewall. Default 'true'
