...
def get_network_isolated(filter: Optional[pulumi.InputType['GetNetworkIsolatedFilterArgs']] = None,
...
@_utilities.lift_output_func(get_network_isolated)
def get_network_isolated_output(filter: Optional[pulumi.Input[Optional[pulumi.InputType['GetNetworkIsolatedFilterArgs']]]] = None,
                                name: Optional[pulumi.Input[Optional[str]]] = None,
                                org: Optional[pulumi.Input[Optional[str]]] = None,
                                vdc: Optional[pulumi.Input[Optional[str]]] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNetworkIsolatedResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
